...
# FILENAME:
smldata = ds.small_data('/reg/d/psdm/cxi/%s/scratch/northeyt/xint_binning_run%d.h5' %(experiment, run), gather_interval=100)  #This creates a 'small-data file' in your scratch folder, which is later loaded into the i_ub script
